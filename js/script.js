...
//-----------modal window--START--------------
let button1 = document.querySelector('[data-modal-btn]');
let modal1 = document.querySelector('[data-modal]');
let btnClose1 = document.querySelector('[data-modal-close]');
...
modal1.querySelector('.modal1-window').addEventListener('click', function(e){
    e.stopPropagation();
})
//-----------modal window--FINISH--------------
...
const footercellphone = document.getElementById('footercellphone');
...
footerform.addEventListener('submit',function(e) {
    ...
    checkRequired([footerusername, footeremail, footercellphone]);
    checkLength(footerusername,3,15);
    checkLength(footercellphone,6,25);
    checkEmail(footeremail);
    // checkPasswordMatch(password, password2);
});


let footerinputName = document.querySelector('.footerinputName');
let footerinputCellphone = document.querySelector('.footerinputCellphone');
let footerinputEmail = document.querySelector('.footerinputEmail');
    document.querySelector('.footername-btn').onclick = function(){
        let name = footerinputName.value;
        let cellphone = footerinputCellphone.value;
        let email = footerinputEmail.value;
        localStorage.setItem('key', name + ',  '+ cellphone +',  ' + email);
}
